...
--Read the data from the votes.csv file

-- Creates votes to be and array containg an array of strings.
votes ::  [[String]]

-- Sets votes to be equal to the contents of the votes.csv file.
votes = [["","","D. Abbott","E. Balls","A. Burbhm","D. Milliband","E. Milliband"],
    ["1","Ms D Abbott MP  ","1","*","*","*","*"],
...
-- Clean and Rearrange the data ”as necessary”.

-- Develop the Alternative vote Algorithm

-- Develop the Single Transferable Vote Algorithm
